(() => {
  ...
  const CHAT_KB = [
    ...
    { keywords: ['menu', 'food', 'items', 'options'], reply: `Here's what's on: <br>• Beef Suya: £12.00<br>• Lamb: £10.00<br>• Chopped Chicken: £10.00<br>• Chicken Skewers: 5 for £10.00<br>• Plantain: £2.50 per portion<br>All hand-rolled in our own yaji spice and grilled fresh to order. ${waButton('Order via WhatsApp', `Hi! I chatted with the KenSuya assistant and I'd like to see the full menu and place an order please.`)}` },
