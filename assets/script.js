(() => {
  ...
  const CHAT_KB = [
    ...
    { keywords: ['beef'], reply: `Beef Suya (£12.00) — our signature. Thin-sliced beef, hand-rolled in yaji spice and grilled fast over an open flame.` },
    { keywords: ['lamb'], reply: `Lamb (£10.00) — tender lamb, double-dusted in yaji, char-grilled till the edges catch. A fan favourite.` },
    ...
    { keywords: ['plantain'], reply: `Sweet fried plantain (£2.50 per portion) — caramelised at the edges, the perfect cool-down side.` },
    { keywords: ['corn'], reply: `Grilled corn on the cob (£3.00), brushed with butter and a dusting of yaji.` },
    { keywords: ['party', 'platter', 'catering', 'cater', 'event', 'group', 'wedding', 'birthday'], reply: `We build platters and larger orders for events — mix of beef, chicken, lamb and sides. ${waButton('Message us your headcount & date')}` },
